...
- (void)drawRect:(CGRect)rect {
    ...
    if (_hideBtn) {
        CGPoint point = CGPointMake(boxRect.origin.x+boxRect.size.width, boxRect.origin.y);
        _hideBtn.frame = CGRectMake(0, 0, boxRect.size.width/4, boxRect.size.width/4);
        _hideBtn.center = point;
